...
- Run bundled scripts relative to this folder, for example `./yeet/scripts/...` from the repo root.
...
- Branch: `agent CLI/{description}` when starting from main/master/default.
- Commit: `{description}` (terse).
- PR title: `[agent CLI] {description}` summarizing the full diff.

## Workflow

- If on main/master/default, create a branch: `git checkout -b "agent CLI/{description}"`
