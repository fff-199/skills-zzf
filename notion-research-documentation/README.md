...
- Run bundled scripts relative to this folder, for example `./notion-research-documentation/scripts/...` from the repo root.
...
### 2) Select the format
- Quick readout 鈫?quick brief.
- Single-topic dive 鈫?research summary.
- Option tradeoffs 鈫?comparison.
- Deep dive / exec-ready 鈫?comprehensive report.
...
- `reference/` 鈥?search tactics, format selection, templates, and citation rules (e.g., `advanced-search.md`, `format-selection-guide.md`, `research-summary-template.md`, `comparison-template.md`, `citations.md`).
- `examples/` 鈥?end-to-end walkthroughs (e.g., `competitor-analysis.md`, `technical-investigation.md`, `market-research.md`, `trip-planning.md`).
