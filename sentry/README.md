...
- Run bundled scripts relative to this folder, for example `./sentry/scripts/...` from the repo root.
...
export SENTRY_API="./sentry/scripts/sentry_api.py"
```
...
Example prompt: 鈥淟ist the top 10 open issues for prod in the last 24h.鈥?Expected: ordered list with titles, short IDs, counts, last seen.
