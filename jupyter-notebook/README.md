...
- Run bundled scripts relative to this folder, for example `./jupyter-notebook/scripts/...` from the repo root.
...
export JUPYTER_NOTEBOOK_CLI="./jupyter-notebook/scripts/new_notebook.py"
```
...
Script path:
- `$JUPYTER_NOTEBOOK_CLI` (installed default: `./jupyter-notebook/scripts/new_notebook.py`)
