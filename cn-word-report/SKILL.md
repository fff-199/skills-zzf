---
name: cn-word-report
description: "Design, tighten, and polish Chinese report-style Word documents (.docx) for leadership, client, or internal review. Use when Codex needs to create or revise Chinese汇报稿/方案汇总/调研报告 with strong structure, integrated narrative, image-table-caption coherence, and tight pagination; especially when sections feel fragmented, cases are scattered, images are unclear, or large blank spaces appear between major sections."
---
