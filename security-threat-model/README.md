...
- Run bundled scripts relative to this folder, for example `./security-threat-model/scripts/...` from the repo root.
...
- Ask 1鈥? targeted questions to resolve missing context (service owner and environment, scale/users, deployment model, authn/authz, internet exposure, data sensitivity, multi-tenancy).
- Pause and wait for user feedback before producing the final report.
- If the user declines or can鈥檛 answer, state which assumptions remain and how they influence priority.
